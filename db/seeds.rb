...
# # IMPROVED ABILITIES
#
# ImprovedAbilities.create(symbol: 'improved_abilities_elevation_terrain_symbol', movement: 'This character can move up or down across Elevated terrain (without using elevation change squares).', targeting: 'Lines of fire drawn by this character are not blocked by Elevated terrain.')
# ImprovedAbilities.create(symbol: 'improved_abilities_hindering_terrain_symbol', movement: 'This character does not stop moving when moving into terrain that is hindering for movement purposes and does not halve its speed value when beginning movement from terrain that is hindering for movement purposes.', targeting: 'Lines of fire drawn by this character can’t be hindered.')
# ImprovedAbilities.create(symbol: 'improved_abilities_water_terrain_symbol', movement: 'This character does not stop moving when moving into Water terrain and does not halve its speed value when beginning movement from Water terrain.', targeting: '-')
# ImprovedAbilities.create(symbol: 'improved_abilities_blocking_terrain_symbol', movement: 'This character can move through Blocking terrain.', targeting: 'Lines of fire drawn by this character are not blocked by Blocking terrain.')
# ImprovedAbilities.create(symbol: 'improved_abilities_outdoor_blocking_terrain_symbol', movement: 'This character can move through Outdoor Blocking terrain.', targeting: '-')
# ImprovedAbilities.create(symbol: 'improved_abilities_blocking_terrain_damage_symbol', movement: 'This character can move through Blocking terrain. Immediately after movement resolves, destroy all Blocking terrain moved through.', targeting: 'Once per range attack, this character can draw a line of fire through one piece of Blocking terrain. Immediately after the attack resolves, destroy that piece of Blocking terrain.')
# ImprovedAbilities.create(symbol: 'improved_abilities_unblocked_symbol', movement: 'This character can move through squares adjacent to or occupied by opposing characters without stopping, and automatically breaks away, even if adjacent to a character that can use Plasticity.', targeting: 'Lines of fire drawn by this character are not blocked by characters.')
# ImprovedAbilities.create(symbol: 'improved_abilities_unblocked_break_away_symbol', movement: 'This character can move through squares adjacent to or occupied by opposing characters without stopping. (Still needs to break away.)', targeting: 'This character can make range attacks while adjacent to opposing characters. (May target adjacent or non-adjacent opposing characters.)')
#
# # Team Affiliations
#
